...
>
> The _operating posture_ below (manual disputes, low caps, single keys acceptable at beta scale,
...
different gates, and conflating them is what stalled shipping. Clear _this_ list, launch
...
- **Disputes: manual.** You are the resolver. Handle them case-by-case off-chain (evidence
  ...
  a _mainnet_ P0, not a beta one — at beta scale it is just you.
...
- Automated voucher slashing as a _relied-upon_ mechanism.
...
dispute by hand. That is the beta. Ship it, watch what sticks or breaks, and let _that_ —
