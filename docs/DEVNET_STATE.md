...
- Floors: `0.01 USDC` paid listing minimum, `1.00 USDC` minimum vouch stake, `1.00 USDC` minimum author bond _for free listings only_, `0.50 USDC` dispute bond. Protocol fee: `0%`.
