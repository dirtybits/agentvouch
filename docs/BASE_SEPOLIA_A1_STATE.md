...
| ------------------------------------ | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A: pre-broadcast candidate           | **NO-GO**   | The 2026-07-31 evidence refresh passes pinned Foundry format/build/121 tests/size/rehearsal, Forge/client ABI parity, format/lint/typecheck/chain-map, 867 web tests, UI, harness, and the 151-page production webpack build. Exact candidate commit/review, approved inputs, external review/risk acceptance, rollback review, and human GO remain pending |
...
- `npm run verify:base-a1-client-abi` loaded the fresh Forge artifact and passed canonical parity for
