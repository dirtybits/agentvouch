...
- **Base Sepolia Deployment Gates A–D** control deployment stages. They cover candidate verification,
  paused deployment, an isolated lifecycle test, and testnet activation.
- **AgentVouch Protocol Requirements A1–A5** define product and security behavior across chains.
  They cover voucher slashing, dispute governance, emergency pause, the refund and restitution
  reserve, and security review. This table reports the Base implementation status.
...
disposable-database rehearsal, WAF/monitoring proof, and explicit activation review land.
...
protocol receipt, author proceeds, voucher rewards, paid Report/slashing path, or buyer credit.
